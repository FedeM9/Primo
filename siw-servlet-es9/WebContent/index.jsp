...
<body>
		<header> <h1 >Prodotti</h1>  </header>
		<div align="center"><article >			
					...
					<div>Data Scadenza*:  <input type="text"name="dataScadenza" value="${prodotto.dataScadenza}" />${errDataScadenza}</div>
					<div>* Campo Obbligatorio</div>
					<input type="submit" name="command" value="invia" />
					
		</form>
		<div><a href="prodotto">Lista Prodotti</a></div>  
		</article></div>
</body>
</html>